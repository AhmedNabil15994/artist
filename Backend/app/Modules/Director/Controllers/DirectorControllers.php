...
class DirectorControllers extends Controller {
    ...
    {   
        if($request->ajax()){
            $data = Director::dataList(null,null,2);
            return Datatables::of($data['data'])->make(true);
        }
        return view('Director.Views.index');
    }

    public function add() {
        return view('Director.Views.add');
    }
    ...
    public function edit($id) {
        ...
        return view('Director.Views.edit')->with('data', (object) $data);      
    }
    ...
    public function fastEdit() {
        ...
        WebActions::newType(4,'Director');
        return \TraitsFunc::SuccessResponse('تم التعديل بنجاح');
    }

    public function arrange() {
        $data = Director::dataList();
        return view('Director.Views.arrange')->with('data', (Object) $data);;
    }
    ...
    public function charts() {
        ...
        $data['title'] = 'مجلس الادارة';
        $data['miniTitle'] = 'مجلس الادارة';
        $data['url'] = 'director';
