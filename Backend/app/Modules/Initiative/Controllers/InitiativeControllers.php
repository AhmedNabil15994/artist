...
class InitiativeControllers extends Controller {
    ...
    {   
        if($request->ajax()){
            $data = Event::dataList(null,null,2);
            return Datatables::of($data['data'])->make(true);
        }
        return view('Initiative.Views.index');
    }

    public function add() {
        return view('Initiative.Views.add');
    }
    ...
    public function edit($id) {
        ...
        return view('Initiative.Views.edit')->with('data', (object) $data);      
    }
    ...
    public function delete($id) {
        ...
        WebActions::newType(3,'Initiative');
    ...
    public function fastEdit() {
        ...
        WebActions::newType(4,'Initiative');
        return \TraitsFunc::SuccessResponse('تم التعديل بنجاح');
    }

    public function arrange() {
        $data = Event::dataList();
        return view('Initiative.Views.arrange')->with('data', (Object) $data);;
    }
    ...
    public function charts() {
        ...
        $addCount = WebActions::getByDate($date,$start,$end,1,'Initiative')['count'];
        $editCount = WebActions::getByDate($date,$start,$end,2,'Initiative')['count'];
        $deleteCount = WebActions::getByDate($date,$start,$end,3,'Initiative')['count'];
        $fastEditCount = WebActions::getByDate($date,$start,$end,4,'Initiative')['count'];

        $data['chartData1'] = $this->getChartData($start,$end,1,'Initiative');
        $data['chartData2'] = $this->getChartData($start,$end,2,'Initiative');
        $data['chartData3'] = $this->getChartData($start,$end,4,'Initiative');
        $data['chartData4'] = $this->getChartData($start,$end,3,'Initiative');
