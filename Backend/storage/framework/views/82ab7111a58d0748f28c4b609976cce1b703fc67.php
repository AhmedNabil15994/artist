<?php $__env->startSection('title','الاتصال بنا'); ?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(URL::to('/contactUs')); ?>" class="text-muted">الاتصال بنا</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="main-menu dropdown dropdown-inline">
                ...
                <div class="dropdown-menu" dropdown-toggle="hover">
                    <?php if(\Helper::checkRules('charts-contactUs')): ?>
                    <a href="<?php echo e(URL::to('/contactUs/charts')); ?>" class="dropdown-item">
...
<div class="card card-custom">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <?php if(\Helper::checkRules('edit-contactUs')): ?>
    ...
    <div class="card-body">
                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="<?php echo e(URL::current()); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <input type="text" class="form-control m-input" data-col-index="1" name="name" value="<?php echo e(Request::get('name')); ?>" data-col-index="1">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>البريد الالكتروني:</label>
                                    <input type="email" class="form-control m-input" data-col-index="2" name="email" value="<?php echo e(Request::get('email')); ?>" data-col-index="1">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>محتوي الرسالة:</label>
                                    <input type="text" class="form-control m-input" data-col-index="4" name="message" value="<?php echo e(Request::get('message')); ?>" data-col-index="1">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>الرد:</label>
                                    <input type="text" class="form-control m-input" data-col-index="5" name="reply" value="<?php echo e(Request::get('reply')); ?>" data-col-index="1">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-9 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_1" placeholder="من"  name="from" value="<?php echo e(Request::get('from')); ?>" data-col-index="6" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_1" />
                                        </div>
                                        <div class="col">
                                            <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_2" placeholder="الي"  name="to" value="<?php echo e(Request::get('to')); ?>" data-col-index="6" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_2" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="<?php echo e(URL::to('/contactUs')); ?>" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
        ...
        <input type="hidden" name="data-area" value="<?php echo e(\Helper::checkRules('edit-contactUs')); ?>">
        <input type="hidden" name="data-cols" value="<?php echo e(\Helper::checkRules('delete-contactUs')); ?>">
        <!--begin: Datatable-->
...
<script src="<?php echo e(asset('/assets/components/contactUs-datatables.js')); ?>"></script>           
<?php $__env->stopSection(); ?>

<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Edite2/Backend/app/Modules/ContactUs/Views/index.blade.php ENDPATH**/ ?>