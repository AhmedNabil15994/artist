<?php $__env->startSection('title','شروط البطاقات - تعديل'); ?>
    ...
    <div class="card-body">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="AddTabs" role="tabpanel">
                <form class="forms m-form m-form--group-seperator-dashed" method="POST" action="<?php echo e(URL::to('/conditions/update/'.$data->data->id)); ?>">  
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Edite2/Backend/app/Modules/Condition/Views/edit.blade.php ENDPATH**/ ?>