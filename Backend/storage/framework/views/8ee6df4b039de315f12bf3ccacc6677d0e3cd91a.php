    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                <?php if(\Helper::checkRules('list-directors,list-founders')): ?>
                <li class="menu-item menu-item-submenu <?php echo e(Active(URL::to('/founders*'),'menu-item-open active')); ?> <?php echo e(Active(URL::to('/directors*'),'menu-item-open active')); ?>" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="#" class="menu-link menu-toggle">
                        <i class="menu-icon flaticon-event-calendar-symbol"></i>
                        <span class="menu-text">المؤسسين ومجلس الادارة</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu" kt-hidden-height="80">
                        <span class="menu-arrow"></span>
                        <ul class="menu-subnav">
                            ...
                            <?php if(\Helper::checkRules('list-founders')): ?>
                            <li class="menu-item <?php echo e(Active(URL::to('/founders*'))); ?>" aria-haspopup="true">
                                <a href="<?php echo e(URL::to('/founders')); ?>" class="menu-link ">
                                    <i class="menu-bullet menu-bullet-dot"></i>
                                    <span class="menu-text">المؤسسين</span>
                                </a>
                            </li>
                            <?php endif; ?>
                            <?php if(\Helper::checkRules('list-directors')): ?>
                            <li class="menu-item <?php echo e(Active(URL::to('/directors*'))); ?>" aria-haspopup="true">
                                <a href="<?php echo e(URL::to('/directors')); ?>" class="menu-link ">
                                    <i class="menu-bullet menu-bullet-dot"></i>
                                    <span class="menu-text">مجلس الادارة</span>
                                </a>
                            </li>
                            <?php endif; ?>
                        </ul>
                ...
                <?php if(\Helper::checkRules('list-events,list-initiatives')): ?>
                <li class="menu-item menu-item-submenu <?php echo e(Active(URL::to('/events*'),'menu-item-open active')); ?> <?php echo e(Active(URL::to('/initiatives*'),'menu-item-open active')); ?>" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="#" class="menu-link menu-toggle">
                        <i class="menu-icon flaticon-event-calendar-symbol"></i>
                        <span class="menu-text">الفعاليات و المبادرات</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu" kt-hidden-height="80">
                        <span class="menu-arrow"></span>
                        <ul class="menu-subnav">
                            ...
                            <?php endif; ?>
                            <?php if(\Helper::checkRules('list-initiatives')): ?>
                            <li class="menu-item <?php echo e(Active(URL::to('/initiatives*'))); ?>" aria-haspopup="true">
                                <a href="<?php echo e(URL::to('/initiatives')); ?>" class="menu-link ">
                                    <i class="menu-bullet menu-bullet-dot"></i>
                                    <span class="menu-text">المبادرات</span>
                                </a>
                            </li>
                            <?php endif; ?>
                        </ul>
                ...
                <?php if(\Helper::checkRules('list-regulations')): ?>
                <li class="menu-item menu-item-submenu <?php echo e(Active(URL::to('/regulations*'),'menu-item-open active')); ?>" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="#" class="menu-link menu-toggle">
                        <i class="menu-icon fa fa-tag"></i>
                        <span class="menu-text">لوائح وسياسات</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu" kt-hidden-height="80">
                        <span class="menu-arrow"></span>
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item <?php echo e(Active(URL::to('/regulations*'))); ?>" aria-haspopup="true">
                                <a href="<?php echo e(URL::to('/regulations')); ?>" class="menu-link ">
                                    <i class="menu-bullet menu-bullet-dot"></i>
                                    <span class="menu-text">لوائح وسياسات</span>
                                </a>
                            </li>
