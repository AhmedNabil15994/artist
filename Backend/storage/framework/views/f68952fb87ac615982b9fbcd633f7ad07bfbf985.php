        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(URL::to('/memberships')); ?>" class="text-muted">العضويات</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
...
<div class="card card-custom">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <?php if(\Helper::checkRules('edit-membership')): ?>
    ...
    <div class="card-body">
                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="<?php echo e(URL::current()); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <input type="text" class="form-control m-input" data-col-index="1" name="title" value="<?php echo e(Request::get('title')); ?>">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>السعر:</label>
                                    <input type="text" class="form-control m-input" data-col-index="2" name="price" value="<?php echo e(Request::get('price')); ?>">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>السعر بعد الخصم:</label>
                                    <input type="text" class="form-control m-input" data-col-index="3" name="discount_price" value="<?php echo e(Request::get('discount_price')); ?>">
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="<?php echo e(URL::to('/memberships')); ?>" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
        ...
        <input type="hidden" name="data-area" value="<?php echo e(\Helper::checkRules('edit-membership')); ?>">
        <input type="hidden" name="data-cols" value="<?php echo e(\Helper::checkRules('delete-membership')); ?>">
        <!--begin: Datatable-->
...
<script src="<?php echo e(asset('/assets/components/memberships-datatables.js')); ?>"></script>           
...
<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Edite2/Backend/app/Modules/Membership/Views/index.blade.php ENDPATH**/ ?>