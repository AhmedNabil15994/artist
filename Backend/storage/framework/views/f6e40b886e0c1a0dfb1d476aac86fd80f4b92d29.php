<?php $__env->startSection('title','شروط البطاقات'); ?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(URL::to('/conditions')); ?>" class="text-muted">شروط البطاقات</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="main-menu dropdown dropdown-inline">
                ...
                <div class="dropdown-menu" dropdown-toggle="hover">
                    ...
                    <a href="<?php echo e(URL::to('/conditions/add')); ?>" class="dropdown-item">
                        <i class="m-nav__link-icon fa fa-plus"></i>
                        <span class="m-nav__link-text">اضافة</span>
                    </a>
                    <?php endif; ?>
                    <?php if(\Helper::checkRules('sort-condition')): ?>
                    <a href="<?php echo e(URL::to('/conditions/arrange')); ?>" class="dropdown-item">
                    ...
                    <a href="<?php echo e(URL::to('/conditions/charts')); ?>" class="dropdown-item">
...
<div class="card card-custom">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <?php if(\Helper::checkRules('edit-condition')): ?>
    ...
    <div class="card-body">
                    ...
                    <div class="card-body">
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="<?php echo e(URL::current()); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>الوصف:</label>
                                    <input type="text" class="form-control m-input" name="description" value="<?php echo e(Request::get('description')); ?>" data-col-index="2">
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="<?php echo e(URL::to('/conditions')); ?>" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
        ...
        <input type="hidden" name="data-area" value="<?php echo e(\Helper::checkRules('edit-condition')); ?>">
        <input type="hidden" name="data-cols" value="<?php echo e(\Helper::checkRules('delete-condition')); ?>">
        <!--begin: Datatable-->
...
<script src="<?php echo e(asset('/assets/components/conditions-datatables.js')); ?>"></script>           
<?php $__env->stopSection(); ?>

<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Edite2/Backend/app/Modules/Condition/Views/index.blade.php ENDPATH**/ ?>