...
<html>
	...
	<body>
	   	...
	   	<div class="card {{ $data->order->membership_id == 1 ? '' : 'card2' }}">
	    	<div class="cardHead">
	    		<img src="{{ asset('/assets/card/images/logo.png') }}" class="logo1" />
	    		<img src="{{ asset('/assets/card/images/logo2.png') }}" class="logo2" />
	    		<div class="line"></div>
	    	</div>
	    	<div class="details">
		    	<div class="info">
	    	...
	    	<img src="{{ asset('/assets/card/images/footerLine.png') }}" class="footerLine" />
	   </div>
